                 ...
                 <input type="hidden" name="id" value="<?= $getlokasi['id']; ?>"/>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('latitude') ? 'is-invalid':'' ?>"
								 type="text" name="latitude" value="<?= $getlokasi['latitude']; ?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('longitude') ? 'is-invalid':'' ?>"
								 type="text" name="longitude" value="<?= $getlokasi['longitude']; ?>"/>
								<div class="invalid-feedback">
									<?php echo form_error('longitude') ?>
								</div>
							</div>
							<input class="btn btn-success" type="submit" name="btn" value="Update" />&nbsp; <a href="<?= base_url('gis');?> " class="btn btn-warning">Cancel</a>
            </form>
        </div>
        </div>
        <hr>

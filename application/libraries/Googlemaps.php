...
class Googlemaps {
	...
	var $center						= "-7.2622734,112.7460179";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $clusterGridSize			= 500;						// The grid size of a cluster in pixels
